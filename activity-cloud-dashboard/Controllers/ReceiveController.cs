...
namespace ActivityApp.Controllers
{
    class ReceiveController
    {
        ...
        public void Init(){
            ...
            Console.WriteLine("Application " + instance);
            SensorsData sensorsData = instance.GetSensorsData();
        ...
        // az iot hub show --query properties.eventHubEndpoints.events.path --name rg-newhub
        //private readonly static string s_eventHubsCompatiblePath = "";
        private readonly static string s_eventHubsCompatiblePath = "";
        
        // az iot hub policy show --name service --query primaryKey --hub-name {your IoT Hub name}
        // az iot hub policy show --name service --query primaryKey --hub-name rg-newhub
